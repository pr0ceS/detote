...
import { newVisit } from "../utils/visitApi";
...
export async function initVisit() {
  ...
  const referrer = document.referrer;
	...
	if(data !== undefined) {
		newVisit(data.fingerprint, data.ip, data.visitRef, data.origin, data.country, data.utm_source, data.utm_medium, data.referrer)
	}
}