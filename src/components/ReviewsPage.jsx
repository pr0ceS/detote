...
const ReviewForm = ({ onSubmit }) => {
  ...
  return (
    <div className="review-form-container">
      ...
      <button className="button" onClick={handleSubmit}>Stuur in</button>
    </div>
  );
};
        ...
        <section>
          <div className="customer-reviews">
            {displayedReviews.map((review, index) => (
              <div key={index} className="review">
                ...
                {review.image && (
                  <img src={review.image} alt="Review image" decoding="async" loading="lazy" />
                )}
              </div>
            ))}
            {loadMoreVisible && (
              <button className="button" onClick={loadMoreReviews}>Laad meer</button>
            )}
          </div>
          <div className="overall-rating">
            ...
            <div className="overall-rating-top">
              ...
              <div>
                <b><p>{`${reviews.filter((review) => review.stars >= 3).length} van de ${reviews.length} (${Math.floor(recommendPercentage)}%)`}</p></b>
                <p>Klanten raden dit product aan</p>
              </div>
            </div>
            ...
            <div className="overall-rating-write">
              <div className="overall-rating-text">
                <div>
                  ...
                  <p>Deel uw ervaring met anderen</p>
                </div>
                <button className="button" onClick={() => openReviewForm()}>Review Schrijven</button>
              </div>
